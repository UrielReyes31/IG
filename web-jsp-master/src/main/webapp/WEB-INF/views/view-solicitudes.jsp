        ...
        <table border="1"><tr><th>ID</th><th>First Name</th><th>Last Name</th></tr>
            <c:forEach var="item" items="${solicitudes}">
                <tr>
                    ...
                    <td>
                        <table border="1"><tr><th>ID</th><th>Nombre</th><th>existencia</th><th>Consumo</th><th>Pedido</th></tr>
                    ...
                    <td><a href="http://localhost:8080/web_jsp_war/viewCotizaciones">"Ver Cotizaciones Compra"</a></td>
                </tr>
            </c:forEach>
        </table>
    </c:when>
